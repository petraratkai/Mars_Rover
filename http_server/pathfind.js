...
function checkPivot(checked, hitboxlist, hitboxindex, halfspan, margin, relativePos, Iy, cplxcoeff, startpt, endpt){
    ...
    var radius = (maths.re(hitboxes[hitboxindex][1]) - maths.re(hitboxes[hitboxindex][2]) )/2;
    var centre = maths.divide(maths.add(hitboxes[hitboxindex][0], hitboxes[hitboxindex][2]), 2);
    var pivot;
