...
const long f_i = 1000;           //time to move in forward direction, please calculate the precision and conversion factor
const long r_i = 1200;           //time to rotate clockwise
const long b_i = 3000;           //time to move backwards
